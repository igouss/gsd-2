// WTF Extension — Dynamic Model Router
// Maps complexity tiers to models, enforcing downgrade-only semantics.
// The user's configured model is always the ceiling.

import type { ComplexityTier, ClassificationResult, TaskMetadata } from "../analysis/complexity-classifier.ts";
import { tierOrdinal } from "../analysis/complexity-classifier.ts";
import type { ResolvedModelConfig } from "../preferences/preferences.ts";
