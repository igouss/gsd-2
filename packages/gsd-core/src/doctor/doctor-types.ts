...
export interface DoctorReport {
  ...
  issues: DoctorIssue[];
  fixesApplied: string[];
  /** Per-domain check durations in milliseconds. Present on explicit /wtf doctor runs. */
  timing?: { git: number; runtime: number; environment: number; wtfState: number };
}
