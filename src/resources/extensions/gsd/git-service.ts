...
import { buildTaskCommitMessage, type TaskCommitContext } from "./commit-utils.js";
...
// Re-export for backward compatibility — canonical definitions in commit-utils.ts / errors.ts
export type { TaskCommitContext } from "./commit-utils.js";
export { buildTaskCommitMessage, inferCommitType } from "./commit-utils.js";
