...
test('#1886: worktree VALIDATION.md preserved (not overwritten)', async () => {
...
test('#1886: missing worktree files still copied', async () => {
  const mainBase = createBase("main");
  const wtBase = createBase("wt");
...
test('#1886: completed-units.json forward-synced to worktree', async () => {
  const mainBase = createBase("main");
  const wtBase = createBase("wt");
...
test('#1886: completed-units.json no-op when missing in project root', async () => {
  const mainBase = createBase("main");
  const wtBase = createBase("wt");
